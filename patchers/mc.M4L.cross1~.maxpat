...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 152.0, 64.0, 20.0 ],
					"text" : "clip -50. 50."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 176.0, 106.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.0, 128.0, 80.0, 20.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.0, 200.0, 80.0, 20.0 ],
					"text" : "zl join 50."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.0, 272.0, 60.0, 20.0 ],
					"text" : "mc.+~ 0.75"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 104.0, 304.0, 57.0, 20.0 ],
					"text" : "mc.cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 48.0, 304.0, 57.0, 20.0 ],
					"text" : "mc.cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 88.0, 336.0, 35.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 32.0, 336.0, 35.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 144.0, 224.0, 49.0, 20.0 ],
					"text" : "mc.line~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 153.5, 246.0, 95.5, 246.0 ],
					"order" : 1,
					"source" : [ "obj-76", 0 ]
				}
